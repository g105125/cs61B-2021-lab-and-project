...
public class Dog implements Serializable{ // TODO
    ...
    public void f(){
        String s="Woof! My name is "+name+" and I am a "+breed+"! I am "+age+" years old! Woof!";
    ...
    public void saveDog () throws IOException {
        File fdog=join(DOGS_FOLDER,name);
        if(!fdog.exists())fdog.createNewFile();

        writeObject(fdog,this);
    }
